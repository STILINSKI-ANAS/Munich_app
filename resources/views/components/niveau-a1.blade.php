                    ...
                    <div class="content">
                        <div class="content text-start">
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active">Niveau A1</li>
                            </ul>
                            <h2 class="title">{{$niveau}}</h2>
                            <p class="description">Une personne de niveau A1 en allemand peut comprendre et utiliser des
                                expressions simples de la vie quotidienne, comme saluer, se présenter et poser des
                                questions basiques sur des sujets familiers. Elle peut également communiquer
                ...
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-border-with-box thuumbnail">
                            <img class="w-100" src="{{asset('assets/images/course/A1.jpg')}}" alt="Card image">
                        </div>
                        <!-- start tag Area -->
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30 has-show-more"
                            ...
                            <div class="rbt-course-feature-inner has-show-more-inner-content">
                                ...
                                <p>L'apprentissage de l'allemand ouvre les portes vers un avenir sans limites.</p>

                                <div class="row g-5 mb--30">
                                    <!-- Start Feture Box  -->
                                    <div class="col-lg-6">
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Le vocabulaire de base.</li>
                                            <li><i class="feather-check"></i>Premiers éléments grammaticaux.
                                            </li>
                                            <li><i class="feather-check"></i>Compléments de vocabulaire.
                                            </li>
                                            <li><i class="feather-check"></i>Expression écrite simple.
                                            </li>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Conversation usuelle.
                                            </li>
                                            <li><i class="feather-check"></i>Modalités pédagogiques :</li>
                                            <li><i class="feather-check"></i>Cours individuels : dans nos locaux</li>
                                            <li><i class="feather-check"></i>Cours collectifs : en entreprise ou dans
                                                nos locaux
                                            </li>
                                        </ul>
                                    </div>
                                    ...
                                    <div class="accordion" id="accordionExampleb2">
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo1">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                    ...
                                                    les notions simples de la vie quotidienne.
                                                </button>
                                            </h2>
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire de base.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Premiers éléments grammaticaux.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Compléments de vocabulaire.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Expression écrite simple.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Conversation usuelle.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Modalités pédagogiques :
                                                                Cours individuels : dans nos locaux
                                                                Cours collectifs : en entreprise ou dans nos locaux.</span>
                                                                </div>
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les nombres, les dates, les heures</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">L’alphabet et la phonétique.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les couleurs, les animaux, le corps.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les actions de la vie quotidienne.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Se présenter.</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo3">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseTwo3" aria-expanded="true"
                                                        aria-controls="collapseTwo3">
                                                    Premiers éléments grammaticaux
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Pronoms personnels, adjectifs possessifs.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les verbes irréguliers</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">La voix passive.</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo4">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseTwo4" aria-expanded="true"
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les sentiments.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">La maison, le téléphone.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire spécifique à la vie sociale et professionnelle du stagiaire.</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo5">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseTwo5" aria-expanded="true"
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Comprendre les idées essentielles d’un texte court
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Pouvoir rédiger un texte court sur un thème simple.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Faire un résumé de texte</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Ecrire un courrier</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo6">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse"
                                                        data-bs-target="#collapseTwo6" aria-expanded="true"
                                                        aria-controls="collapseTwo6">
                                                    Conversation usuelle
                                                </button>
                                            </h2>
                                            <div id="collapseTwo6" class="accordion-collapse collapse show"
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation d’échange autour de ses goûts, de ses activités personnelles ou professionnelles.</span>
                                                                </div>
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        ...
                                        <li><i class="feather-calendar"></i><span>L’après-midi de &nbsp;</span> <strong
                                                class="text-primary"> 15h00 </strong> à <strong class="text-primary">&nbsp;
                                                18h00</strong></li>
