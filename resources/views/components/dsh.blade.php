                ...
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-border-with-box thuumbnail">
                            <img class="w-100" src="assets/images/course/DSH.jpg" alt="Card image">
                        </div>
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30 has-show-more" id="Objectifs">
                            <div class="rbt-course-feature-inner has-show-more-inner-content">
                                <div class="section-title">
                                    <h4 class="rbt-title-style-3">Qu'est-ce que le test DSH ?
                                    </h4>
                                </div>
                                <p>Le test DSH (Deutsche Sprachprüfung für den Hochschulzugang) est un examen de compétence en langue allemande destiné aux étudiants internationaux souhaitant étudier dans des universités allemandes. Le test évalue la capacité
                                    des candidats à comprendre et à utiliser l'allemand dans un contexte académique. Le résultat du test DSH est souvent un prérequis pour l'admission aux études universitaires en Allemagne.
                                <p>
                                ...
                                <div class="row g-5 mb--30">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Accès aux universités allemandes </li>
                                            <li><i class="feather-check"></i>Évaluation des compétences académiques
                                            </li>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Préparation au milieu universitaire allemand
                                            </li>
                                            <li><i class="feather-check"></i>Voyages et culture</li>
                                ...
                                <div class="rbt-card variation-01 rbt-hover">
                                    <div class="rbt-card-img">
                                        <a href="course-details.html">
                                            <img src="assets/images/course/DAF.jpg" alt="Card image">
