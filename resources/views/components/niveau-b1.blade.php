                    ...
                    <div class="content">
                        <div class="content text-start">
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active">Niveau B1</li>
                            </ul>
                            <h2 class="title">Niveau B1</h2>
                            <p class="description">Une personne de niveau B1 en allemand est capable d'interagir dans des situations courantes, d'exprimer ses opinions et ses idées sur des sujets familiers, ainsi que de comprendre des textes simples tels que des courriels ou
                ...
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-border-with-box thuumbnail">
                            <img class="w-100" src="{{ asset('assets/images/course/B1.jpg') }}" alt="Card image">
                        </div>
                        <!-- start tag Area -->
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30 has-show-more" id="Objectifs">
                            <div class="rbt-course-feature-inner has-show-more-inner-content">
                                ...
                                <p>Pouvoir participer aisément à un dialogue courant ou professionnel, et pouvoir comprendre et commenter l’intégralité d’un texte écrit.
                                ...
                                <div class="row g-5 mb--30">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="rbt-list-style-1">
                                            ...
                                            <li><i class="feather-check"></i>Vocabulaire courant ou professionnel.
                                            </li>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Rapports et courriers personnels ou professionnels.
                                            </li>
                                            <li><i class="feather-check"></i>Rendez-vous, entretien téléphonique</li>

                                        </ul>

                                    </div>
                                    <!-- End Feture Box  -->
                                    <p>Stagiaires ayant suivi le module A2 ou personnes maîtrisant déjà les éléments de base du langage courant. Une évaluation initiale vous est proposée afin d’adapter le contenu du stage à vos besoins réels.
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Rappels sur les principaux temps
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Conjugaisons.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le groupe nominal.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les auxiliaires modaux.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">La concordance des temps.</span>
                                                                </div>

                                                            </a>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Premières phrases simples.</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo3">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo3" aria-expanded="true" aria-controls="collapseTwo3">
                                                    Vocabulaire courant ou professionnel
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire de la vie courante.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire commercial.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire technique.</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo4">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo4" aria-expanded="true" aria-controls="collapseTwo4">
                                                    Rapports et courriers personnels et professionnels
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Dégager les grandes lignes d’un texte.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Compréhension détaillée d’un texte
                                                                        .</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Perfectionnement de la lecture : découpage, phonologie, rythme, intonation…
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Ecrire un courrier
                        ...
                        <div class="inner">
                            ...
                            <div class="content-item-content">
                                <div class="rbt-price-wrapper d-flex flex-wrap align-items-center justify-content-between">
                                    <div class="rbt-price">
                                        <span class="current-price">MAD {{$price}}</span>
                                ...
                                <div class="rbt-widget-details ">
                                    <ul class=" rbt-course-details-list-wrapper">
                                        <div class="row">
                                            <div class="col-6">
                                                <li><input type="text" placeholder="Nom" required></li>
                                                <li><input type="text" placeholder="Prénom" required></li>
                                                <li><input type="text" placeholder="Sexe" required></li>
                                                <li><input type="text" placeholder="Date de naissance" required></li>
                                            </div>
                                            <div class="col-6">
                                                <li><input type="text" placeholder="Numéro de téléphone" required></li>
                                                <li><input type="text" placeholder="Adresse e-mail" required></li>
                                                <li><input type="text" placeholder="Lieu de naissance" required></li>
                                                <li><input type="text" placeholder="Pays de naissance" required></li>
                                            </div>
                                        </div>
                                        <li><input type="text" placeholder="Numéro de passeport ou CNE" required></li>
                                        <li><input type="text" placeholder="Adresse actuelle" required></li>
                                    </ul>
