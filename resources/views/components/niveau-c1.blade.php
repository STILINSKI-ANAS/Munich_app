                    ...
                    <div class="content">
                        <div class="content text-start">
                            <ul class="page-list">
                                ...
                                <li class="rbt-breadcrumb-item active">Niveau C1</li>
                            </ul>
                            <h2 class="title">Niveau C1</h2>
                            <p class="description">Une personne de niveau C1 en allemand maîtrise la langue de manière avancée et peut communiquer avec aisance et spontanéité dans des situations variées. Elle comprend des textes complexes, tels que des articles académiques
                                ou littéraires, et est capable de s'exprimer de façon fluide et précise sur des sujets abstraits et concrets.
                ...
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-border-with-box thuumbnail">
                            <img class="w-100" src="{{ asset('assets/images/course/C1.jpg') }}" alt="Card image">
                        </div>
                        <!-- start tag Area -->
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30 has-show-more" id="Objectifs">
                            <div class="rbt-course-feature-inner has-show-more-inner-content">
                                ...
                                <p>L’intéressé a la capacité d’user, dans son quotidien et son travail, d’un niveau comparable à quelqu’un dont la langue est maternelle, et de dominer la langue en détail dans des présentations, des rapports ou des explications.
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <p class="rbt-card-text">Le DSH est un examen de compétences en langue allemande qui...</p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <p class="rbt-card-text">Le Test DAF est un examen destiné aux personnes étrangères qui...</p>
