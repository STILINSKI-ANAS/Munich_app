                ...
                <div class="col-lg-8">
                    <div class="content">
                        <div class="content text-start">
                            <ul class="page-list">
                                <li class="rbt-breadcrumb-item"><a href="index.html">Langue allemande
                                    </a></li>
                                <li>
                                    <div class="icon-right"><i class="feather-chevron-right"></i></div>
                                </li>
                                <li class="rbt-breadcrumb-item active">Niveau B2</li>
                            </ul>
                            <h2 class="title">Niveau B2</h2>
                            <p class="description">Au niveau B2 en allemand, la personne est capable de communiquer de manière avancée et précise. Elle peut exprimer ses idées clairement et argumenter sur des sujets variés, y compris des sujets abstraits.
                            ...
                            <div class="d-flex align-items-center mb--20 flex-wrap rbt-course-details-feature">
                                ...
                                <div class="feature-sin best-seller-badge">
                                    <span class="rbt-badge-2">
                                            <span class="image"><img src="{{ asset('assets/images/icons/card-icon-1.png') }}" alt="Best Seller Icon"></span>Tendance</span>
                                </div>
                ...
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-border-with-box thuumbnail">
                            <img class="w-100" src="{{ asset('assets/images/course/B2.jpg') }}" alt="Card image">
                        </div>
                        <!-- start tag Area -->
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30 has-show-more" id="Objectifs">
                            <div class="rbt-course-feature-inner has-show-more-inner-content">
                                ...
                                <p>Comprendre les textes longs et complexes, ainsi que les significations implicites. Pouvoir s’exprimer de façon courante, efficace et souple dans la vie de tous les jours comme dans la vie professionnelle. Reconnaître les
                                ...
                                <div class="row g-5 mb--30">
                                    ...
                                    <!-- End Feture Box  -->
                                    <p>Stagiaires ayant suivi le module 2 ou personnes ayant déjà une bonne maîtrise de la langue. Une évaluation initiale vous est proposée afin d’adapter le contenu du stage à vos besoins réels
                                ...
                                <div class="rbt-accordion-style rbt-accordion-02 accordion">
                                    <div class="accordion" id="accordionExampleb2">
                                                ...
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Cours individuels : dans nos locaux.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Cours collectifs : en entreprise ou dans nos locaux.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les cours à domicile peuvent vous faire bénéficier d’une réduction d’impôts de 50 % (suivant loi de finances en vigueur)
                                        ...
                                        <div class="accordion-item card">
                                            ...
                                            <div id="collapseTwo2" class="accordion-collapse collapse show" aria-labelledby="headingTwo2" data-bs-parent="#accordionExampleb2">
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Rappels sur les principaux temps et en particulier le passé avec ses différentes nuances de formes progressives
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les auxiliaires modaux et leurs équivalents</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les dénombrables et indénombrables</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Les verbes prépositionnels et les verbes à particule adverbiale</span>
                                                                </div>
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo3">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo3" aria-expanded="true" aria-controls="collapseTwo3">
                                                    Les champs lexicaux spécifiques


                                                </button>
                                            </h2>
                                            <div id="collapseTwo3" class="accordion-collapse collapse show" aria-labelledby="headingTwo3" data-bs-parent="#accordionExampleb2">
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire journalistique.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire professionnel.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire touristique.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire géographique.</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire du quotidien
                                                                        .</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Le vocabulaire spécifique aux activités personnelles ou professionnelles du stagiaire
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo4">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo4" aria-expanded="true" aria-controls="collapseTwo4">
                                                    Compréhension approfondie


                                                </button>
                                            </h2>
                                            <div id="collapseTwo4" class="accordion-collapse collapse show" aria-labelledby="headingTwo4" data-bs-parent="#accordionExampleb2">
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Comprendre n’importe quel texte (articles de presse, roman, brochure touristique…)
                                                                        .</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Faire la synthèse d’un ou plusieurs documents
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Rédiger une lettre, un e-mail, un CV, une lettre de motivation
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo5">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo5" aria-expanded="true" aria-controls="collapseTwo5">
                                                    Compréhension approfondie


                                                </button>
                                            </h2>
                                            <div id="collapseTwo5" class="accordion-collapse collapse show" aria-labelledby="headingTwo5" data-bs-parent="#accordionExampleb2">
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation de présentations simples
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation d’échange autour de ses goûts, de ses activités personnelles ou professionnelles
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Echange de questions-réponses simples</span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Comprendre un texte audio ou video avec locuteur à débit lent
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation de voyage touristique en pays étranger
                                        ...
                                        <div class="accordion-item card">
                                            <h2 class="accordion-header card-header" id="headingTwo6">
                                                <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo6" aria-expanded="true" aria-controls="collapseTwo6">
                                                    Expression orale approfondie


                                                </button>
                                            </h2>
                                            <div id="collapseTwo6" class="accordion-collapse collapse show" aria-labelledby="headingTwo6" data-bs-parent="#accordionExampleb2">
                                                <div class="accordion-body card-body pr--0">
                                                    <ul class="rbt-course-main-content liststyle">
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Pouvoir comprendre différents accents et nuances apportés par le locuteur
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation d’un entretien téléphonique
                                                                    </span>
                                                                </div>
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation d’une discussion sur un thème donné
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Simulation d’une réservation (hôtel, avion, train…)
                                                        ...
                                                        <li>
                                                            <a href="">
                                                                <div class="course-content-left">
                                                                    <i class="feather-check"></i><span class="text">Echange de questions-réponses simples
                            ...
                            <div class="row g-5">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <ul class="rbt-list-style-1">
                                        ...
                                        <li><i class="feather-calendar"></i><span>L’après-midi de &nbsp;</span> <strong class="text-primary"> 15h00 </strong>&nbsp; à <strong class="text-primary">&nbsp; 18h00</strong></li>
                                    ...
                                    <div class="media-body">
                                        <div class="author-info">
                                            ...
                                            <ul class="rbt-meta mb--20 mt--10">
                                                <li><i class="fa fa-star color-warning"></i>75,237 Reviews <span class="rbt-badge-5 ml--5">4.9 Avis</span></li>
                                                <li><i class="feather-users"></i>501 Students</li>
                                            </ul>
                                        </div>
                                        <div class="content">
                                            <p class="description">Les enseignants de langue inspirent les étudiants à trouver leur voix dans une nouvelle langue et à découvrir la beauté de l'échange culturel.</p>
                    ...
                    <div class="related-course mt--60">
                        ...
                        <div class="row g-5">
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <div class="rbt-card variation-01 rbt-hover">
                                    ...
                                    <div class="rbt-card-body">
                                        ...
                                        <p class="rbt-card-text">"Une personne de niveau A1 en allemand peut comprendre et utiliser des expressions simples de la vie quotidienne…
                                        </p>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                <div class="rbt-card variation-01 rbt-hover">
                                    ...
                                    <div class="rbt-card-body">
                                        ...
                                        <p class="rbt-card-text">Une personne de niveau B1 en allemand est capable d'interagir dans des situations courantes..</p>
                            ...
                            <div class="row g-5">
                                <!-- Start Single Card  -->
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt--50" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                    <div class="rbt-card variation-01 rbt-hover">
                                        <div class="rbt-card-img">
                                            <a href="course-details.html">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <p class="rbt-card-text">Au niveau B2 en allemand, la personne est capable de communiquer de manière avancée et précise....
                                            </p>
                                ...
                                <div class="col-lg-6 col-md-6 col-sm-6 col-12 mt--50" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                                    <div class="rbt-card variation-01 rbt-hover">
                                        ...
                                        <div class="rbt-card-body">
                                            ...
                                            <p class="rbt-card-text">Une personne de niveau C1 en allemand maîtrise la langue de manière avancée et peut communiquer avec aisance et spontanéité.. </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <p class="rbt-card-text">Le DSH est un examen de compétences en langue allemande qui vous permet d’étudier dans une université allemande. L’examen écrit comprend 3 parties: compréhension orale, compréhension écrite et rédaction (durée totale: 4
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <p class="rbt-card-text">Le Test DAF est un examen destiné aux personnes étrangères qui apprennent l’allemand et qui souhaitent étudier en Allemagne, ou qui ont besoin d’un certificat qui atteste de leurs compétences linguistiques. Le résultat
                                    attribué correspond à l’un des 3 niveaux mentionnés dans le « Cadre Européen Commun de Référence pour les Langues » (de B2 à C2). </p>
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-6 col-12" data-sal-delay="150" data-sal="slide-up" data-sal-duration="800">
                        <div class="rbt-card variation-01 rbt-hover">
                            ...
                            <div class="rbt-card-body">
                                ...
                                <p class="rbt-card-text">Le WiDaF (Deutsch als Fremdsprache in der Wirtschaft) est un diplôme d’allemand qui sert à attester des compétences d’une personne non-germanophone dans cette langue en milieu professionnel </p>
