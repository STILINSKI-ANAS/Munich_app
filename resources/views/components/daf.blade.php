                ...
                <div class="col-lg-8">
                    <div class="content">
                        <div class="content text-start">
                            ...
                            <h2 class="title">Test DAF
                            </h2>
                            <p class="description">Le test DAF (Deutsch als Fremdsprache) est un examen de compétence en langue allemande pour les apprenants non natifs. Il évalue la capacité des candidats à comprendre et à utiliser l'allemand dans différentes situations de
                                la vie quotidienne, tant à l'oral qu'à l'écrit. Le test DAF est souvent utilisé pour attester du niveau de compétence en allemand dans des contextes non académiques, tels que le travail, l'immigration ou le séjour dans
                ...
                <div class="col-lg-8">
                    <div class="course-details-content">
                        <div class="rbt-course-feature-box rbt-border-with-box thuumbnail">
                            <img class="w-100" src="assets/images/course/DAF.jpg" alt="Card image">
                        </div>
                        ...
                        <div class="rbt-course-feature-box overview-wrapper rbt-border-with-box mt--30 has-show-more" id="Objectifs">
                            <div class="rbt-course-feature-inner has-show-more-inner-content">
                                <div class="section-title">
                                    <h4 class="rbt-title-style-3">Qu'est-ce que le test DAF ?
                                    </h4>
                                </div>
                                <p>Le test DAF (Deutsch als Fremdsprache) est un examen de compétence en langue allemande pour les apprenants non natifs. Il évalue la capacité des candidats à comprendre et à utiliser l'allemand dans différentes situations
                                    de la vie quotidienne, tant à l'oral qu'à l'écrit. Le test DAF est souvent utilisé pour attester du niveau de compétence en allemand dans des contextes non académiques, tels que le travail, l'immigration ou le séjour
                                ...
                                <div class="row g-5 mb--30">
                                    ...
                                    <div class="col-lg-6">
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Évaluation globale des compétences linguistiques </li>
                                            <li><i class="feather-check"></i>Reconnaissance internationale
                                            </li>
                                            <li><i class="feather-check"></i>Préparation au quotidien en Allemagne
                                            </li>
                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <ul class="rbt-list-style-1">
                                            <li><i class="feather-check"></i>Preuve de compétence en allemand
                                            </li>
                                            <li><i class="feather-check"></i>Motivation pour l'apprentissage</li>
