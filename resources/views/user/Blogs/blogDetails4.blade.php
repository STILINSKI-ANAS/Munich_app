    ...
    <div class="rbt-overlay-page-wrapper">
        <div class="breadcrumb-image-container breadcrumb-style-max-width">
            ...
            <div class="breadcrumb-content-top text-center">
                ...
                <h1 class="title">Guide Complet du Visa Schengen pour les Citoyens Marocains se Rendant en Allemagne</p>
            </div>
        </div>
        ...
        <div class="rbt-blog-details-area rbt-section-gapBottom breadcrumb-style-max-width">
            <div class="blog-content-wrapper rbt-article-content-wrapper">
                <div class="content">
                    ...
                    <div class="wp-block-gallery columns-3 is-cropped">
                        <ul class="blocks-gallery-grid">
                            <li class="blocks-gallery-item">
                                <figure>
                                    <img class="radius-4" src="assets/images/blog/travel.jpg" alt="Blog Images">
                                </figure>
                            </li>
                            <li class="blocks-gallery-item">
                                <figure>
                                    <img class="radius-4" src="assets/images/blog/travel2.jpg" alt="Blog Images">
                                </figure>
                            </li>
                            <li class="blocks-gallery-item">
                                <figure>
                                    <img class="radius-4" src="assets/images/blog/travel3.jpg" alt="Blog Images">
                                </figure>
                            </li>
                        </ul>
                    </div>

                    <h4>Visa Schengen pour l'Allemagne pour les citoyens marocains</h4>
                    ...
                    <div class="post-thumbnail mb--30 position-relative wp-block-image alignwide">
                        <figure>
                            <img src="assets/images/blog/flag.jpg" alt="Blog Images">
                    ...
                    <!-- BLog Tag Clound  -->
                    <div class="tagcloud">
                        <a href="#">Visapourl'Allemagne</a>
                        <a href="#">SchengenpourMarocains</a>
                        <a href="#">Allemagne</a>
                        <a href="#">TravailleretÉtudier</a>
                        <a href="#">Règlesd'entréeAllemagne</a>
                    ...
                    <div class="social-share-block">
                        <div class="post-like">
                            <a href="#"><i class="feather feather-thumbs-up"></i><span>10.2k J'aime</span></a>
                        </div>
                                    ...
                                    <div class="single-comment">
                                        ...
                                        <div class="comment-inner">
                                            ...
                                            <div class="comment-meta">
                                                <div class="time-spent">Mars 04, 2023 at 08:23 Am</div>
                            ...
                            <li class="comment">
                                <div class="comment-body">
                                    <div class="single-comment">
                                        ...
                                        <div class="comment-inner">
                                            <h6 class="commenter">
                                                <a href="#">Samir Chana</a>
                                            </h6>
                                            <div class="comment-meta">
                                                <div class="time-spent">Juin 10, 2023 at 20:26 pm</div>
                                                <div class="reply-edit">
                                                    <div class="reply">
                                                        <a class="comment-reply-link" href="#">Répondre</a>
                                                    </div>
