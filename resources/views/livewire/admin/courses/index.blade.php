        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="modal-footer pt--30">
                    <button type="submit" {{$showSubmitButton}} wire:click.prevent="destroyCourse" class="rbt-btn btn-xs bg-color-danger-opacity radius-round color-danger m-1">Oui</button>
