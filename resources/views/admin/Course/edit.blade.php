        ...
        <form action="{{ url('admin/Course/'. $course->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="rbt-course-field-wrapper rbt-default-form   row">
                ...
                <div class="col-lg-6">
                    <div class="course-field mb--15">
                        ...
                        <div class="rbt-modern-select bg-transparent height-50 mb--10">
                            <select required name="language_id" class="w-100" data-live-search="true" title="{{$course->name}}" multiple data-size="7" data-actions-box="true" data-selected-text-format="count > 2" id="language_id" tabindex="null">
                                @foreach($languages as $language)
                                    <option name="language_id" value="{{ $language->id }}" {{ $course->language_id == $language->id ? 'selected' : '' }}>
                                        {{ $language->name }}
                                    </option>
                                @endforeach
                            </select>
                ...
                <div class="course-field mb--15">
                    ...
                    <input required id="regularPrice-1" type="number" placeholder="$ Regular Price" name="price" value="{{$course->price }}">
                ...
                <div class="col-lg-12">
                    <div class="course-field mb--15">
                        ...
                        <textarea required id="whatLearn" rows="5" placeholder="Add your course benefits here." name="time"> {{$course->time }}</textarea>
                ...
                <div class="col-lg-12">
                    <div class="course-field mb--15">
                        ...
                        <textarea required id="whatLearn" rows="5" placeholder="Add your course benefits here." name="overview">{{$course->overview }}</textarea>
                        <small class="d-block mt_dec--5"><i class="feather-info"></i> Enter for per line.</small>
                    </div>
                </div>
                <div class="col-lg-12">
                    <div class="course-field mb--15">
                        ...
                        <textarea required id="description" rows="5" placeholder="Add your course benefits here." name="content">{{$course->content }}</textarea>
                        <small class="d-block mt_dec--5"><i class="feather-info"></i> Enter for per line.</small>
                    </div>
                </div>
