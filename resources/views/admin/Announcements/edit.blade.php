        ...
        <form action="{{ url('admin/Announcements/'. $announcement->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="rbt-course-field-wrapper rbt-default-form row">
                <div class="course-field mb--15 col-lg-6">
                    ...
                    <input id="field-1" type="text" placeholder="Entrez le titre de l'annonce" name="titre" value={{$announcement->titre}}>
                ...
                <div class="col-lg-12">
                    <div class="course-field mb--15">
                        ...
                        <textarea id="description" rows="10" placeholder="Ajouter les détails sur l'annonce ici" name="description" >{{$announcement->description}}</textarea>
                    </div>
                </div>
