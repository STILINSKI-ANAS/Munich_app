            ...
            <div class="rbt-course-field-wrapper rbt-default-form">
                ...
                <div class="col-lg-6">
                    ...
                    <div class="col-lg-12">
                        <div class="course-field mb--15">
                            ...
                            <textarea required id="description" rows="5" placeholder="Add The test Features here" name="features"></textarea>
                            <small class="d-block mt_dec--5"><i class="feather-info"></i> Enter for per line.</small>
                        </div>
                    </div>
                ...
                <div class="col-lg-6">
                    <div class="course-field mb--15">
                        ...
                        <div class="rbt-modern-select bg-transparent height-50 mb--10">
                            <div class="dropdown bootstrap-select show-tick w-100">
                                <select required name="course_id" class="w-100" data-live-search="true" title="Selecter ici" multiple="" data-size="7" data-actions-box="true" data-selected-text-format="count > 2" id="course_id" tabindex="null">
                                    @foreach($courses as $course)
                                        <option name="course_id" value="{{ $course->id }}">{{$course->level}}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
